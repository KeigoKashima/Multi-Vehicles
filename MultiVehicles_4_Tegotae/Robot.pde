...
class Robot{
        ...
        Robot(float x, float y){
                ...
                pjd2.enableLimit = false;//可動範囲を有効にするか 
        ...
        void textDistance(int i){
                ...
                text("N: "+N,1*width/20, (i+1)*height/40);
                text("phi: "+phi,5*width/20, (i+1)*height/40);
                text("dH: "+dH,10*width/20, (i+1)*height/40);
        }
